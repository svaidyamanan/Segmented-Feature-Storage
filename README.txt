...
bin/					      API used for HDT creation and query. Modified from online library.
...
batch_create.sh		  For every image, calls 'mpi_convert' to convert the tiles in the image to ADIOS/HDT/SQLite and distributes them to nfs004, nfs005 and nfs006
